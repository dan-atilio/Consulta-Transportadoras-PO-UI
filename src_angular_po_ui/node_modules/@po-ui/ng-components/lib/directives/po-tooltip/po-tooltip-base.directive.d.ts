...
export declare abstract class PoTooltipBaseDirective {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoTooltipBaseDirective, never, never, { "appendInBody": { "alias": "p-append-in-body"; "required": false; }; "hideArrow": { "alias": "p-hide-arrow"; "required": false; }; "innerHtml": { "alias": "p-inner-html"; "required": false; }; "tooltip": { "alias": "p-tooltip"; "required": false; }; "tooltipPosition": { "alias": "p-tooltip-position"; "required": false; }; "displayTooltip": { "alias": "p-display-tooltip"; "required": false; }; }, {}, never, never, true, never>;
    static ngAcceptInputType_appendInBody: any;
    static ngAcceptInputType_hideArrow: any;
    static ngAcceptInputType_innerHtml: any;
    static ngAcceptInputType_displayTooltip: any;
}
