...
export declare class PoDisclaimerGroupBaseComponent implements DoCheck {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoDisclaimerGroupBaseComponent, never, never, { "title": { "alias": "p-title"; "required": false; }; "disclaimers": { "alias": "p-disclaimers"; "required": false; }; "hideRemoveAll": { "alias": "p-hide-remove-all"; "required": false; }; }, { "change": "p-change"; "remove": "p-remove"; "removeAll": "p-remove-all"; }, never, never, true, never>;
}
