...
export declare class PoDynamicViewBaseComponent extends PoDynamicSharedBase {
    ...
    protected getValueFields(): {
        ...
        optionsService?: string | import("@po-ui/ng-components").PoComboFilter | import("@po-ui/ng-components").PoMultiselectFilter;
        ...
        visible?: boolean;
        divider?: string;
        type?: string | import("@po-ui/ng-components").PoDynamicFieldType;
        container?: string;
        value: any;
        cssClass: string;
    }[];
