 ...
 * ```
 */
export declare class PoPageSlideFooterComponent {
    /**
     * @optional
     *
     * @description
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<PoPageSlideFooterComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<PoPageSlideFooterComponent, "po-page-slide-footer", never, { "disabledAlign": { "alias": "p-disabled-align"; "required": false; }; }, {}, never, ["*"], false, never>;
}
