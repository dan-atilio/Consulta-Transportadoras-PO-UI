 ...
 *
 */
export declare class PoDividerBaseComponent implements OnInit {
    coordinateX1: string;
    coordinateX2: string;
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoDividerBaseComponent, never, never, { "label": { "alias": "p-label"; "required": false; }; "borderWidth": { "alias": "p-border-width"; "required": false; }; }, {}, never, never, true, never>;
}
