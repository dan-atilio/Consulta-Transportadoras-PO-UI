...
export declare class PoImageBaseComponent {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoImageBaseComponent, never, never, { "height": { "alias": "p-height"; "required": false; }; "alternate": { "alias": "p-alt"; "required": false; }; "source": { "alias": "p-src"; "required": false; }; "priority": { "alias": "p-priority"; "required": false; }; "loading": { "alias": "p-loading"; "required": false; }; }, {}, never, never, true, never>;
}
export {};
