...
export declare class PoAvatarBaseComponent {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoAvatarBaseComponent, never, never, { "src": { "alias": "p-src"; "required": false; }; "loading": { "alias": "p-loading"; "required": false; }; "size": { "alias": "p-size"; "required": false; }; }, { "click": "p-click"; }, never, never, true, never>;
}
